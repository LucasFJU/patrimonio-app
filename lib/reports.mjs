...
export function reportTransactions(finance,month,{view='accrual',kind='all',category:filterCategory='all'}={}){
 ...
 return finance.transactions.filter(t=>(view==='cash'?monthOf(t.date):(t.competenceMonth||monthOf(t.date)))===month&&included(t)&&eligible.includes(t.type))
