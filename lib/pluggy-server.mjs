...
export async function fetchPluggyItem(itemId,startDate){
 ...
 const listed=await request(`/accounts?itemId=${encodeURIComponent(itemId)}`,{key}),accounts=Array.isArray(listed)?listed:(listed.results||[]);
